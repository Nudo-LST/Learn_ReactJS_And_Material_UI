//remember to import './kilo/CSS/HomeTemplate1.css';
import { a } from "../../kiloC.jsx";

let HomeTemlate1 = (props) => {
  return (
    <div class="container">
      <div class="header">
        <a className="menu-icon" href="https://www.google.com">
          <svg
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        <div class="header-menu">
          <a href="https://www.google.com">Mask</a>
          <a href="https://www.google.com">Helmet</a>
          <a href="https://www.google.com">Bottle</a>
        ...
        <div class="main-wrapper swiper-wrapper">
            ...
            <div class="left-side">
              ...
              <div class="main-content">
                ...
                <div class="main-content__subtitle">
                  ...
                  every year.It takes around 450 years for one plastic bottle to
                  decompose.
                </div>
                <div class="more-menu">
                  Shop Now
          ...
          <div class="main swiper-slide" id="savanna">
            <div class="left-side">
              ...
              <div class="main-content">
                <div class="main-content__title">
                  The Earth’s area affected by desertification is approx 11
                  times India’s size.
                </div>
                <div class="main-content__subtitle">
                  The Savannas act as a carbon sink, absorbing CO2 from the
                  atmosphere and helping to maintain the balance of global
                  temperatures.
                </div>
                <div class="more-menu">
                  Shop Now
            ...
            <div class="left-side">
              ...
              <div class="main-content">
                ...
                <div class="main-content__subtitle">
                  ...
                  rising of the sea level and the deficiency of freshwater,
                  among others.
                </div>
                <div class="more-menu">
                  Shop Now
